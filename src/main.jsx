...
function Quote({settings,inventory,setInventory,catalog,quotes,setQuotes,orders,setOrders,clients,setClients,models,setModels,designDraft,onDraftConsumed,onOrderCreated}){
  ...
  const order=()=>{
    ...
    const createdOrder={...q,id:uid(),quoteId:q.id,status:'pending',createdAt:new Date().toISOString(),dueDate:'',paymentDueDate:'',advanceEnabled:false,payments:[],inventoryDeductions}
